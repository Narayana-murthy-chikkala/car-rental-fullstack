  ...
  const cardsData = [
        {
            ...
            handle: '@neilstellar',
            date: 'April 20, 2025',
            review: 'We have hired cars with other companies and been stuck in queues for hours. This was barely 5 minutes thanks to the app’s seamless pre-registration process.'
        },
        {
            ...
            handle: '@averywrites',
            date: 'May 10, 2025',
            review: 'The luxury car rental experience was flawless. The vehicle was pristine, and the secure payment system made everything effortless.'
        },
        {
            ...
            handle: '@jordantalks',
            date: 'June 5, 2025',
            review: 'Exceptional service! The driver verification process gave me peace of mind, and the car was delivered right on time.'
        },
        {
            ...
            handle: '@averywrites',
            date: 'May 10, 2025',
            review: 'Renting a luxury car was so easy. The app’s interface is intuitive, and the support team was incredibly responsive.'
        },
    ];

    const CreateCard = ({ card }) => (
        <motion.div initial={{opacity:0,y:40}} whileInView={{opacity:1,y:0}} transition={{duration:0.6}} viewport={{once:true}} whileHover={{scale:1.05}} className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0">
  ...
  return (
    <>
        ...
        `}</style>
            ...
            <motion.div initial={{opacity:0,y:40}} whileInView={{opacity:1,y:0}} transition={{duration:0.6}} viewport={{once:true}} className="marquee-row w-full mx-auto max-w-5xl overflow-hidden relative">
              <Title title='What Our Customers Say' subTitle='Discover why discerning travellers choose StayVenture for their luxury accommodations around the world' />
            ...
            <motion.div initial={{opacity:0,y:40}} whileInView={{opacity:1,y:0}} transition={{duration:0.6,delay:0.2}} viewport={{once:true}} className="marquee-row w-full mx-auto max-w-5xl overflow-hidden relative">
                <div className="absolute left-0 top-0 h-full w-20 z-10 pointer-events-none bg-gradient-to-r from-white to-transparent"></div>
